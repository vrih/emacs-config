(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-imenu rvm protobuf-mode org-bullets go-autocomplete unicode-fonts dap-mode lsp-treemacs company-lsp lsp-ui lsp-mode prettier-js solarized-theme smartparens-config flycheck-pos-tip ox-gfm ox-jira ox-rfc centered-window yasnippet-snippets org-jira counsel-etags todotxt magit-gitflow counsel-projectile all-the-icons-ivy counsel ivy graphviz-dot-mode robe zenburn-theme iedit groovy-mode yari company-terraform flycheck-jest eslint-fix evil-mc vue-mode json-mode editorconfig projectile-rails rspec-mode rubocop org-beautify-theme org-pretty-table org go-complete inf-ruby ggtags cargo-mode org-journal cargo elmacro flycheck-rust edit-indirect inf-clojure flymd flycheck-mypy scala-mode adoc-mode flycheck-haskell flymake-haskell-multi haskell-mode haskell-snippets web-mode htmlize autopair ace-jump-mode org-gnus helm-notmuch org-mime bbdb visual-fill-column mu4e-multi mu4e go-snippets go-snippet unicode-fonts--instructions ag coffee-mode helm-ag evil-leader use-package evil-smartparens flycheck-tip evil-mode flycheck-ledger flycheck flycheck-clojure evil gmail-message-mode gmail-mode edit-server-htmlize rust-mode clojure-jump-to-file midje-mode gist yaml-mode sql-indent smartparens powerline neotree markdown-mode magit leuven-theme js2-mode helm-projectile helm-git git-gutter edit-server company-web company-restclient company-go company-emoji color-theme-solarized clj-refactor auto-complete-rst ace-flyspell ac-ispell)))
